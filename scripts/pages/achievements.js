    ...
    for (let i = 0; i < current.length; i++) {
        ...
        currentHtml += `				
                <div class="current-info">
					<div class="img-box"><img class="current-img" src="/assets/banners/achievements/${currentEvent[4]}"></div>
					<div class="small-card">
						<h2>${currentEvent[0]}</h2>
						<span>${currentEvent[2]} ${currentEvent[1]}</span>
						<img class="current-badge" src="/assets/badge/${currentEvent[7]}" style="max-width:50%;">
						<p>
							${currentEvent[5]}
						</p>`;
    ...
    for (let i = 0; i < past.length; i++) {
        ...
        pastHtml +=
            `<div class="past-ach-container">
						<div class="past-ach-img"
							style="background-image:url(/assets/banners/achievements/${pastEvent[4]});background-size:cover;background-position:50%;">
						</div>
        ...
        pastHtml += `
						...
						<div class="past-ach-badge"
							style="background-image:url(/assets/badge/${pastEvent[7]});background-size:contain;background-position:center;background-repeat:no-repeat;">
						</div>
					</div>
					<br></br>`;
...
<head>
	...
	<link rel="preload" href="/assets/logos/logo.gif" as="image">
	...
	<link rel="icon" href="/assets/icons/Planet.ico">
...
<body>
	...
	<main>
		<nav-bar></nav-bar>
		<center>
			<img id="achievement-logo" src="/assets/logos/achievements.png" style="max-width:100%;">
...
- By submitting for an Achievement you consent to your art and or stories to be displayed on the homepage, your achievement page or the CF official discord with proper credit.<br>
 			...
 			<div id="fotm">
				<div id="fotm-container">
					<a href="${fotm[11]}"><img id="fotm-img"
							src="/assets/banners/achievements/${fotm[4]}" style="object-position: 40%;"></a>
				</div>
				<div id="fotmbox">
					<div id="fotm-info">
			...
			<p>
				...
				completed by checking your <a href="/activities/my-achievements.html"
