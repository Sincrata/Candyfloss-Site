...
function updateBodyCanvas(current, masterlist, body) {
    ...
    if (current.body.selected === "curled") {
        ...
        if (masterlist["topcoat"][current.topcoat.selected]["base-curled"] !== "none") {
            new_ctx.drawImage(
                changeImageColor(current.topcoat.color,
                    masterlist["topcoat"][current.topcoat.selected]["base-curled"]
                ), 0, 0);
        }
        ...
        if (masterlist["topcoat"][current.topcoat.selected]["base-straight"] !== "none") {
            new_ctx.drawImage(
                changeImageColor(current.topcoat.color,
                    masterlist["topcoat"][current.topcoat.selected]["base-straight"]
                ), 0, 0);
        }
    ...
    //mouth base
    new_ctx.drawImage(
        changeImageColor(current.mouth.color,
            masterlist["mouth"][current.mouth.selected]["base"]
        ), 0, 0);
    //tongue base
    new_ctx.drawImage(
